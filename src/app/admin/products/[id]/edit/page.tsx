  ...
  return (
    <div>
      <div className="h-16 bg-white border-b border-slate-200 flex items-center gap-4 px-6">
        <Link href="/admin/products" className="p-1.5 rounded-lg hover:bg-slate-100 text-slate-500 transition-colors">
      ...
      <div className="p-6 max-w-2xl">
        <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-slate-200 p-6 space-y-5">
          ...
          <div className="flex gap-3 pt-2">
            <Link href="/admin/products" className="flex-1 text-center px-4 py-2.5 border border-slate-300 rounded-lg text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">Cancel</Link>
