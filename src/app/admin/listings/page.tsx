                    ...
                    {l.status === "DRAFT" && (
                      <div className="flex-shrink-0 flex flex-col gap-2 w-56">
                        <input
                          ...
                          className="w-full px-3 py-1.5 text-xs border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                        />
                        <div className="flex gap-2">
                          <button
                            onClick={() => handleAction(l.id, "APPROVED")}
                            disabled={actionId === l.id}
                            className="flex-1 flex items-center justify-center gap-1.5 bg-green-600 hover:bg-green-700 disabled:opacity-60 text-white text-xs font-semibold py-2 rounded-lg transition-colors"
                          >
